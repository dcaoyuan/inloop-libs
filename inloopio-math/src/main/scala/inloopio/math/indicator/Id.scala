...
object Id {
  ...
  def main(args: Array[String]) {
    ...
    val id5 = Id(classOf[Indicator], keya, inloopio.math.timeseries.TFreq.ONE_MIN)
    val id6 = Id(classOf[Indicator], keyb, inloopio.math.timeseries.TFreq.withName("1m").get)
    println(id5 == id6)
  }
}
